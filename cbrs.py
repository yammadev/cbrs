...
def main():
    ...
    # [3.1] Move through all problem cases
    for i in range(problems.shape[0]):
        ...
        # [3.4] Returns the index (row) of the minimum value in distances calculated
        ...
        plt.title(f'Covariance Heatmap #{i} \n Library cases stored {j} - Base to solve problem {i}')
        plt.savefig(f'output/covariance_heatmap_{i}.png', bbox_inches='tight')
        plt.close()
